...
<head>
              ...
              echo"<h1 style='color:black;position:sticky;'>WELCOME </h1><b style = 'color: black;font-size: 25px'><i> ".ucwords($rel['name'])." !</i></b>
                ...
                <div class='row'>
                  <div class='col'>
                    ...
                    // Check if $rel2 is not null before accessing its name field
                    if ($rel2) {
                        echo "<input type='submit' name='submit' class='btn btn-success' style='display:inline;width:200px;margin-left:20px;margin-right:20px;' value='".ucwords($rel2['name'])."'/>";
                    } else {
                        echo "No recent movie available";
                    }
  ...
  <footer class="page-footer font-small blue">
    ...
    <div class="footer-copyright text-center py-3">© 2025 Copyright:
      <a href="">sionsak018gmail.com.com</a>
    </div>
